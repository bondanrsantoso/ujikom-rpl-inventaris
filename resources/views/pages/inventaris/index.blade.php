    ...
    <div class="modal" id="formModal">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="api/inventaris/add" method="POST" id="mainForm" enctype="multipart/form-data" autocomplete="off" novalidate>
                    <input type="hidden" name="api_token" value="{{$token}}">
                    <input type="hidden" name="id" id="idInventaris" value="new">
                    <div class="modal-body">
                        <div class="d-flex flex-column flex-md-row flex-wrap">
                            <div class="form-group col-12">
                                <img src="https://images.pexels.com/photos/1166420/pexels-photo-1166420.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
                                    alt="image" class="inventaris-image hidden mb-2" id="photoPreview">
                                <label for="photo">Foto Inventaris</label>
                                <input type="file" name="photo" accept=".gif,.jpg,.png,.jpeg" id="photo" class="d-block">
                            </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $table.on('select', function(e, dataTable, type, indexes){
            ...
            if(selectedItem[13] != "NULL"){
                $("#photoPreview").attr("src", selectedItem[13]);
