    ...
    <div class="modal" id="formModal">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="api/ruang/add" method="POST" id="mainForm" autocomplete="off">
                    <input type="hidden" name="api_token" value="{{$token}}">
                    <input type="hidden" name="id" id="idRuang" value="new">
                ...
                <form action="api/ruang/delete" method="POST" id="deleteForm">
                    @method('DELETE')
                    <input type="hidden" name="api_token" value="{{$token}}">
                    <input type="hidden" name="id" id="idRuangDelete" value="new">
                </form>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $table.on('select', function(e, dataTable, type, indexes){
            ...
            $("#idRuang").val(selectedItem[0])
            $("#idRuangDelete").val(selectedItem[0])
